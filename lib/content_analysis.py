...
class TagCategories:
    ...
    # 内容类型标签
    CONTENT_TYPE = {
        "教程", "指南", "最佳实践", "案例研究", "技术分享",
        "工具介绍", "框架对比", "性能优化", "安全", "测试",
        "架构设计", "代码审查", "调试技巧"
    }
    
    # 应用场景标签
    SCENARIO = {
        "Web开发", "移动开发", "后端开发", "前端开发", "全栈开发",
        "DevOps", "数据科学", "系统架构", "微服务", "API设计"
    }
    ...
    def get_all_tags(cls) -> set:
        """获取所有可用标签"""
        return (cls.TECH_STACK | cls.CONTENT_TYPE | 
                cls.SCENARIO | cls.INDUSTRY)
